...
public class AmazonProductCatalogBPlusTree {

    private static final int ORDER = 3;
    private BPlusNode root;

    public AmazonProductCatalogBPlusTree() {
    ...
    void displayTree() {
        ...
        System.out.println("                /     \\");
        System.out.println("      [101,105,110]   [120,125,130]");
    ...
    public static void main(String[] args) {
        ...
        AmazonProductCatalogBPlusTree tree =
                new AmazonProductCatalogBPlusTree();
        ...
        System.out.println("AMAZON PRODUCT CATALOG USING B+ TREE");
        System.out.println("------------------------------------");

        System.out.println("\nProducts Inserted:");
        System.out.println("101, 105, 110, 115, 120, 125, 130");
